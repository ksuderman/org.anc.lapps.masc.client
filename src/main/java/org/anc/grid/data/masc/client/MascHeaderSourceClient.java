...
//      private static final String HOST = "http://picard:8080";
      ...
      public static final String NAMESPACE = HOST + "/service_manager/invoker/anc:MASC_HEADERS";
      public static final String ENDPOINT = HOST + "/service_manager/invoker/anc:MASC_HEADERS";
   }
